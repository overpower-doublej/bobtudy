...
public class Gcm {
    ...
    public void getRegId(RegIdHandler handler) {
     ...
     * shared preferences.
     */
    private void registerInBackground(final RegIdHandler handler) {
    ...
    public interface RegIdHandler {
        void onResponse(String regId);
    }
}
